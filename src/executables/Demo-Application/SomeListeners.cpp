...
void CreateVirtualObjectListener::update(){
	...
	state->		attachListenerOnBeginningProgramCycle(  new UpdatePhysicsComponentListener(			vo->getPhysicsComponent()));	// update PhysicsComponent on every program cycle iteration
