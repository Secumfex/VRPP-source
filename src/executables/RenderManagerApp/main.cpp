...
//	Shader *gbufferShader = new Shader(); yay
	...
	/*Shader *gbuffer_phong_Shader = new Shader(		SHADERS_PATH "/GBuffer_clone/GBuffer.vert",
			SHADERS_PATH "/GBuffer_clone/GBuffer_phong.frag");*/
	...
	//rq->addShader(gbuffer_phong_Shader);
