...
void PlayerCamera::setPosition(glm::vec3 newPos){
	if (rigidBody != 0){
...
btRigidBody* PlayerCamera::getRigidBody(){
	return rigidBody;
}

btCollisionShape* PlayerCamera::getCollisionShape(){
