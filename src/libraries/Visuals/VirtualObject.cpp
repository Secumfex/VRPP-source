...
void VirtualObject::setPhysicsComponent(float x, float y, float z, Mesh* mesh, btTriangleMesh btMesh, btTriangleIndexVertexArray* btTIVA){
	if(physicsComponent != NULL)
	physicsComponent->~PhysicsComponent();

	physicsComponent = new PhysicsComponent(x,y,z, mesh, btMesh, mGraphComponent, btTIVA);
}
