...
VirtualObject* ApplicationState::createVirtualObject(std::string path, VirtualObjectFactory::BodyType bodyType){
	VirtualObject* vo = VirtualObjectFactory::getInstance()->createVirtualObject(path, bodyType);
